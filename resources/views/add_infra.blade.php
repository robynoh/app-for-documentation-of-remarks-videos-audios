...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000"> New Infrastructure</b></div>
                            </div>
...
<a  href="infrastructure"   class="btn btn-primary btn"><i class="icon-chevron-left icon-white"></i> All Infrastructure</a>
...
<fieldset>
						...
						<br/><br/>
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="code" type="text" data-required="1" class="span6 m-wrap" />
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="title" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>


                              <div class="control-group">
  								<label class="control-label">Area of Project<span class="required">*</span></label>
  								<div class="controls">
...
<option>Tourism</option>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
                                            <textarea name="description" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"></textarea>
                                          </div>
  							</div>

                              <div class="control-group">
  								<label class="control-label">Town<span class="required">*</span></label>
  								<div class="controls">
  									<input name="location" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>

                              <div class="control-group">
  								<label class="control-label">LGA<span class="required">*</span></label>
  								<div class="controls">
                                      <select name="lga">
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="start" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>


                              <div class="control-group">
  								<label class="control-label">Proposed End Time<span class="required">*</span></label>
  								<div class="controls">
  									<input name="end" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="amount" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="contractor" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>

                              <div class="control-group">
  								<label class="control-label">Partnership<span class="required">*</span></label>
  								<div class="controls">
  									<input name="partnership" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
  							
  							
  							<div class="control-group">
  								<label class="control-label">Benefits<span class="required">*</span></label>
  								<div class="controls">
                                            <textarea name="benefits" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px" required></textarea>
                                          </div>
  							</div>
