...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000"> New  Social Investment Programme</b></div>
                            </div>
		...
		{{csrf_field()}}					
						<br/><br/>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
                                            <textarea name="description" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px" required></textarea>
                                          </div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="effect" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="kind" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<select name="category" class="span6 m-wrap" required>
                                          ...
                                          <option>Social Investment</option>
</select>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="sector" type="text" data-required="1" class="span6 m-wrap" required/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
                                            <textarea name="impact" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px" required></textarea>
                                          </div>
  							</div>
