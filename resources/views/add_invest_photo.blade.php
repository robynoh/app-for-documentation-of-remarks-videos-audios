...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:15px; color:#000"> Investment Photos</b></div>
                            </div>
...
<div class="alert alert-info">
										 ...
										 Upload photos of this investment program here by clicking on the  add photo button above.
									</div>
                                    <?php }?>
...
<form  action="/addinvestphoto/{{$id}}" method="POST" enctype="multipart/form-data" >
...
{{ csrf_field() }}
                              ...
                              <div class="alert alert-info">	
										Please upload photos of selected investment program
									</div>   
...
window.location="/investphoto/delete/"+$('#app_idphoto').val();
...
function showInfraPhotoBox(id){
    ...
    $.get('/photo/pullinvestphotodetail/'+interfaceid,function(detail){
