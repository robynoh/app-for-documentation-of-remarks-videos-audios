...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000"> New  Policies</b></div>
                            </div>
...
<a  href="investment"   class="btn btn-primary btn"><i class="icon-chevron-left icon-white"></i> All Policies</a>
...
<fieldset>
						...
						<br/><br/>
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="title" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>
                              ...
                              <div class="control-group">
  								<label class="control-label">Date of Accension<span class="required">*</span></label>
  								<div class="controls">
  									<input name="date_passed" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>

                              <div class="control-group">
  								<label class="control-label">Name of Assembly<span class="required">*</span></label>
  								<div class="controls">
  									<input name="assembly_name" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>
