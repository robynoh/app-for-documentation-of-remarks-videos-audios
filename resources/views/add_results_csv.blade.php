...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Add results</b></div>
                            </div>
...
@endif
                                ...
                                <div class="span12">
					<!-- BEGIN FORM-->
					<form action="{{route('add.add_results_csv')}}" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="POST">
						<fieldset>
...
<select id="dept" name="department" required>
                            ...
                            <div class="control-group" style="padding-top:10px;padding-left:10px;background:#FFCC66;padding-bottom:10px" >
							  ...
							  <div class="control-group" >
  								...
  								<a href="/result/download/results_bulk_upload_format.csv/folder/{{'uploadFormat'}}">Download Upload Format</a>
                             ...
                             <div class="control-group" >
  								<div class="controls">
									...
									<button type="submit" name="bulkuplo" class="btn btn-success" style="font-size:12px">Upload</button>
									<a href="results" class="btn btn-primary" style="font-size:12px">Go Back</a>
