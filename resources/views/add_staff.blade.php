...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								<div class="muted pull-left"><b style="font-size:14px; color:#000">
								New staff
</b>
							</div>
                            </div>
...
@endif
                                ...
                                <div class="span12">
					<!-- BEGIN FORM-->
					<form action="{{route('post.staff')}}" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
						{{ csrf_field() }}
                              ...
                              <div class="control-group">
  								...
  								<div class="controls">
  									<input name="phone" type="text" class="span6 m-wrap" required/>
  								</div>
  							</div>
