...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000"> All Videos</b></div>
                            </div>
                                        ...
                                        <tbody>
                                         @foreach($videos as $video)
                                            <tr class="gradeU">
                                                ...
                                                <td><h4>{{$video->activity}}</h4>
                                                <span style="padding-right:20px;color:forestgreen;">

                                               <b style="color:grey;"> <i class="icon-users icon-black"></i>Attendance</b> {{ $video->attend}}
</span><br/><br/>
                                            
                                             <span style="font-size:14px;width:100%"> <?php echo $video->url; ?></span><br/><br/>

                                            <span style="color:forestgreen; font-size:16px"> 
                                            <span style="padding-right:20px">  
                                            <b style="color:grey;"> <i class="icon-user icon-black"></i></b>  {{ ucwords($video->postedBy)}}
</span>
<span style="padding-right:20px">

                                               <b style="color:grey;"> <i class="icon-calendar icon-black"></i></b> {{Carbon::parse($video->created_at)->format('M d, Y')}}
</span>
...
<span style="padding-right:50px">
                                               ...
                                               <b style="color:grey;"> <i class="icon-home icon-black"></i></b> {{ ucwords($video->venue)}}
</span>

<span style="float:right"><a  data-userid="" href="/event/{{$video->id}}"   class="btn btn-primary btn"><i class="icon-eye-open icon-white"></i> View More</a></span>
</span>
                                            </td>
