...
<a  data-userid="" href="javascript:void(0)" onclick="showAlertEdit2();"  class="btn btn-primary"><i class="icon-plus icon-white"></i> Add Transcribe</a><br/><br/>		
                                    ...
                                    @foreach($speeches as $speech)
                                        ...
                                        <br/>
<b style="font-size:18px">{{ucfirst($speech->title)}}</b>

<br/><br/>
		
{!!  ucfirst(substr($speech->content,0,500)) !!}
<br/></br>

<a  data-userid="" href="javascript:void(0)" onclick="showViewAlert();"  class="btn btn-inverse btn-mini"><i class="icon-eye-open icon-white"></i> View</a>
<a  id="deleteUser{{ $speech->id}}" data-userid="{{$speech->id }}" href="javascript:void(0)" onclick="showAlertDelete({{ $speech->id}});"  class="btn btn-danger btn-mini"><i class="icon-trash icon-white"></i> Delete</a>
<?php if($speechfiles->count()<1){?>
<a  href="javascript:void(0)" onclick="showFileAlert();"  class="btn btn-success btn-mini"><i class="icon-plus icon-white"></i> Upload Doc.</a>
<?php }else{?>		
    @foreach($speechfiles as $speechfile)
    
    <a href="{{$speechfile->url}}" class="btn btn btn-mini"><i class="icon-file icon-black"></i>View file format</a>
...
{{ csrf_field() }}
                              ...
                              <div class="control-group" style="text-align:left">
                                         <span><b>Title</b></span>
                                         <div class="controls">
                                       <input id="title" name="title" type="text" value="{{$speech->title}}" style="width:100%;height:30px"/>
                                 </div>
                                       </div>
                              ...
                              <div class="modal-footer">
                                  ...
                                  <a data-dismiss="modal" class="btn" href="#">Cancel</a>
                                   ...
                                   <legend></legend>
<div style="font-weight:bold;font-size:18px;color:#090"> Audio	</div>	<br/>
...
<div class="alert alert-info">
<a  onclick="showAudioAlert();" class="btn btn-primary"><i class="icon-plus icon-white"></i> Add Audio</a><br/><br/>		
										 Upload audio of this events/meeting here by clicking on the add audio button above.
									</div>
                                    <?php }?>
...
<br/><br/>									
<a  id="deleteUser{{ $audio->id}}" data-userid="{{$audio->id }}" href="javascript:void(0)"  onclick="showAudioAlertDelete({{$audio->id}});"  class="btn btn-danger btn-mini"><i class="icon-trash icon-white"></i> Delete Audio</a>
...
<div><a href="/all/photos/{{$program->id}}" class="btn btn" > View All Photo</a></div><br/><br/>		
<?php }?>
                                 
                                   
                                    <legend></legend>
<div style="font-weight:bold;font-size:18px;color:#090"> Videos	</div>	<br/>

<?php if($videos->count()<1){?>

<div class="alert alert-info">
<a  href="javascript:void(0)" onclick="showVideoAlert();" class="btn btn-primary"><i class="icon-plus icon-white"></i> Add Videos</a><br/><br/>		
										 Upload videos of this events/ meeting here by clicking on the add video button above.
									</div>   
                                  <?php }else{?>  
                                ...
                                <div class="span12">
						              ...
						              <tbody>
						                <tr>
						                  ...
						                  <td>{{$video->url}}</td>
                                          <td><a href="javascript:void(0)" id="deleteUser{{ $video->id}}" data-userid="{{$video->id}}"  onclick="showVideoDeleteAlert({{$video->id}});" class="btn btn-danger"><i class="icon-trash icon-white"></i></a><br/><br/>		
</td>
						                 @endforeach
						                </tr>
...
<form  action="{{route('add.transcribe')}}" method="POST" enctype="multipart/form-data" >
...
{{ csrf_field() }}
                              ...
                              <label class="control-label" style="text-align:left"><b>Caption Photo</b><span class="required">*</span></label>
                                        ...
                                        <div class="control-group" style="text-align:left">
                                          ...
                                          <div class="controls" style="text-align:left">
                                            <input type="text" name="title"   style="width:100%;height:30px" required>
                                             </div>
                                        </div>
                                        ...
                                        <div class="control-group" style="text-align:left">
                                          <label class="control-label" for="date01"><b>Date of Event</b></label>
                                          <div class="controls" style="text-align:left">
                                            <input type="date" name="time"  value="02/16/12" style="width:250px;height:30px">
                                             </div>
                                        </div>

                            
                              <div class="control-group" style="text-align:left">
                              <label class="control-label" for="date01"><b>Speech</b></label>
                                          <div class="controls">
