									...
									<div class="card card-default">
										...
										<div id="collapseFAQOne" class="collapse show" data-parent="#FAQAccordion">
											<div class="card-body pl-4 w-md-75pct">
												<p class="mb-0">   The prosperity administration lead by His Excellency, Senator douye diri has done several physical developmental projects that will enable the flow of economic activities in other to achieve economic growth and development. <a href="/physical-dev">Read More >></a></p>
											</div>
										</div>
									</div>
									<div class="card card-default">
