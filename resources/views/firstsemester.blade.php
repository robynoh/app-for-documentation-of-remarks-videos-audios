...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000">First Semester Result(s)</b></div>
                            </div>
...
$students->chunk(100, function($rows)use($schoolx, $levelx, $departmentx, $semesterx, $sessionx, $coursesx){
