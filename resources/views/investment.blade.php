...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000"> Social Investments</b></div>
                            </div>
...
<a  href="add_invest"   class="btn btn-success btn"><i class="icon-plus icon-white"></i> Add</a>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2" style="font-size:12px">
                                        <thead>
                                            <tr >
                                               ...
                                               <th width="3%"><input id='selectall' name="" type="checkbox" onClick="selectAll(this,'color')" /></th>
                                                <th>List of Social Investment Programme</th>
                                        ...
                                        <tbody>
                                         @foreach($investments as $investment)
                                            ...
                                            <td><input name="invest[]" type="checkbox" value="{{ $investment->id}}"></td>
                                                <td><h4 style="color:forestgreen">{{$investment->title}}</h4>
                                       
                                             <span style="font-size:14px">   {!!  ucfirst(substr($investment->description,0,200)) !!}</span><br/><br/>

                                            <span style="color:brown; font-size:12px"> 
                                            <span style="padding-right:20px">  
                                            <b style="color:grey;"> <i class="icon-user icon-black"></i></b>  {{ ucwords($investment->postedBy)}}
</span>
<span style="padding-right:20px">

                                               <b style="color:grey;"> <i class="icon-calendar icon-black"></i></b> {{Carbon::parse($investment->created_at)->format('M d, Y')}}
</span>
...
<span style="padding-right:50px">
                                               ...
                                               <b style="color:grey;"> <i class="icon-home icon-black"></i></b> {{ ucwords($investment->sector)}}
</span>
<span style="padding-right:20px">  
                                            <b style="color:grey;"> <i class="icon-film icon-black"></i></b>  Photos ({{resultController::getinvestphotos($investment->id)}})
</span>




<span style="float:right"><a href="/investment/{{ $investment->id}}" class="btn btn-primary"  ><i class="icon-eye-open icon-white"></i> View More</a></span>
</span>

<span style="float:right;padding-right:10px"><a  href="investment-photos/{{ $investment->id}}" class="btn btn"><i class="icon-film icon-black"></i>Add Images</a>
...
<fieldset>
                        ...
                        <div class="control-group">
  								...
  								<div class="controls">
  									<input style="font-weight:bold;size:30px" id="title" name="title" type="text" data-required="1" class="span6 m-wrap" value=""/>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
                                            <textarea id="description"  name="description" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"></textarea>
                                          </div>
  							</div>

                              <div class="control-group">
  								<label class="control-label"><b>Amount of people affected</b><span class="required">*</span></label>
  								<div class="controls">
  									<input id="effect" name="effect" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>

                              <div class="control-group">
  								<label class="control-label"><b>Kind of Programme</b><span class="required">*</span></label>
  								<div class="controls">
  									<input id="kind" name="kind" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>

                              <div class="control-group">
  								<label class="control-label"><b>Sector</b><span class="required">*</span></label>
  								<div class="controls">
  									<input id="sector" name="sector" type="text" data-required="1" class="span6 m-wrap" value=""/>
  								</div>
  							</div>

                            
                              <div class="control-group">
  								<label class="control-label"><b>Estimated Impact</b><span class="required">*</span></label>
  								<div class="controls">
                                            <textarea id="impact" name="impact" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"></textarea>
                                          </div>
  							</div>
...
function showAlert(operand){
    ...
    $.get('pullinvestmentdetail/'+id,function(events){


        $("#id").val(id);
        $("#title").val(events.title);
        $("#description").html(events.description);
        $("#effect").val(events.people_affected);
        $("#kind").val(events.type_program);
        $('#sector').val(events.sector);
        $('#impact').html(events.estimated_impact);
