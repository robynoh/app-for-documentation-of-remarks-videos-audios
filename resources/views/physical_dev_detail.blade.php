								...
								<div class="row">
									<div class="col-md-12 align-self-center p-static text-center">
										<div class="overflow-hidden mb-2">
											<h1 class="font-weight-black text-12 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1200">{{ucfirst($infrastructure->title)}}</h1>
										</div>
									</div>
									<div class="col-md-12 align-self-center">
										<div class="overflow-hidden">
											<ul class="custom-breadcrumb-style-1 breadcrumb breadcrumb-light custom-font-secondary d-block text-center custom-ls-1 text-5 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1450">
												...
												<li class="text-transform-none active">Physical Development</li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="card border-0 border-radius-0">
										<div class="card-body p-0 z-index-1">
											...
											<div class="card-body p-0">
												<p class="card-text mb-2">{!! ucfirst($infrastructure->description) !!}</p>
												...
												<span class="opacity-3 d-inline-block px-2">|</span> 
												<i class="fas fa-map"></i>  {{$infrastructure->project_area}} 

											
											
											</p>

											<h3 class="text-color-quaternary text-capitalize font-weight-bold text-5 m-0 mb-3">Site Visuals</h3>
							...
							<div class="blog-sidebar col-lg-4 pt-4 pt-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800">
								<aside class="sidebar">
									...
									<div class="px-3 mt-4">
										...
										<div class="pb-2 mb-1">
											<?php echo resultController::latestinfra(); ?>
