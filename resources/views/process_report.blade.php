...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000"> Staff list</b></div>
                            </div>
...
@endif
								...
								<a href="add_staff"><button class="btn btn-primary"><i class="icon-plus icon-white"></i> Add Staff</button></a>
