...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000"> School(s)</b></div>
                            </div>
...
@endif
								...
								<form action="add_school"  class="form-horizontal" enctype="multipart/form-data" method="POST">
						
                            	{{ csrf_field() }}
  							
  								
  								
  									<input type="text" name="school_name" data-required="1" class="span6 m-wrap" >
								<button name="add_school" class="btn btn-primary" ><i class="icon-plus icon-white"></i> Add School</button>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2" style="font-size:12px">
                                        ...
                                        @foreach($schools as $school)
                                            <tr class="gradeU">
                                                ...
                                                <td><b>{{$school->school_id}}</b></td>
                                                <td>{{$school->school}}</td>
												
											   
											    <td class="center"><div class="btn-group">
                                                    <a  id="deleteUser{{ $school->school_id}}" data-userid="{{ $school->school_id}}" href="javascript:void(0)" onclick="showAlert({{ $school->school_id}});" ><button class="btn btn-danger"><i class="icon-remove icon-white"></i></button></a></div></td>
                                            	@endforeach
                                            </tr>
                                        </tbody>
                                    </table>
 ...
 <div id="myAlert" class="modal hide">
	 ...
	 {{ csrf_field() }}
											...
											<div class="modal-body">
												<p>Do you want to delete the record of this school? this process can not be undone</p>
...
function senddel(){
    ...
    window.location="/school/delete/"+$('#app_id').val();
