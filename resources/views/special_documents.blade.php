...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:15px; color:#000"> Special Documents</b></div>
                            </div>
...
<a href="javascript:void(0)" onclick="showAudioAlertPhoto();" class="btn btn-primary"><i class="icon-plus icon-white"></i> Add New Document</a><br/><br/>		
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2" style="font-size:12px">
                                        <thead>
                                            <tr >
                                               ...
                                               <th width="3%"><input id='selectall' name="" type="checkbox" onClick="selectAll(this,'color')" /></th>
                                                <th><span style="font-size:14px">List of Saved Documents</span></th>
                                        ...
                                        <tbody>
                                         @foreach($specials as $special)
                                            ...
                                            <td><input name="special[]" type="checkbox" value="{{ $special->id}}"></td>
                                                <td><h4 style="color:forestgreen">{{$special->title}}</h4>
                                       
                                             <span style="font-size:14px">   {!!  ucfirst(substr($special->description,0,200)) !!}</span><br/><br/>

                                            <span style="color:brown; font-size:12px"> 
                                            <span style="padding-right:20px">  
                                            <b style="color:grey;"> <i class="icon-user icon-black"></i>Posted By</b>   {{ ucwords($special->postBy)}}
</span>
<span style="padding-right:20px">  
                                            <b style="color:grey;"> <i class="icon-calendar icon-black"></i>Date Posted</b>   {{ ucwords($special->created_at)}}
</span>
...
<span style="float:right"><a class="btn btn-primary"  id="EditUser{{ $special->id}}" data-userid="{{ $special->id }}" href="javascript:void(0)" onclick="showAlert({{$special->id}});"><i class="icon-download icon-white"></i> Download file</a></span>
</span>
...
{{ csrf_field() }}
                              <div class="modal-header">
                                  <button data-dismiss="modal" class="close" type="button">&times;</button>
                                  <h3 style="font-size:20px;text-align:left">New Document</h3>
                              </div>
                              <div class="modal-body">
                              ...
                              <div class="alert alert-info">	
										Upload Documents/Files you want to save
									</div> 
                                    
                                    <div class="control-group">
  								<label class="control-label" style="text-align:left"><b>Title</b><span class="required">*</span></label>
  								<div class="controls">
  									<input  type="text" id="venue2" name="title" data-required="1" class="span6 m-wrap" style="width:100%;height:30px" required>
  								</div>
                              </div>

                              <div class="control-group">
  								<label class="control-label" style="text-align:left"><b>Description</b><span class="required">*</span></label>
  								<div class="controls">
                                      <textarea name="description" class="span6 m-wrap" style="width:100%"></textarea>
  									</div>
                              </div>
                              ...
                              <label class="control-label" style="text-align:left"><b>Upload document</b><span class="required">*</span></label>
