...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">User list</b></div>
                            </div>
                            <div class="block-content collapse in">
                                ...
                                <a href="{{ route('add.account') }}"><button class="btn btn-warning"><i class="icon-plus icon-white"></i> Add Account</button></a>
...
@endif
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2" style="font-size:12px">
                                        ...
                                        @foreach($users as $user)
                                            <tr class="gradeU">
                                                ...
                                                <td>	<a  id="editUser{{  $user->account_id}}" data-userid="{{ $user->account_id }}" href="javascript:void(0)" onclick="showAlertEdit({{ $user->account_id}});"><button class="btn btn-success"><i class="icon-pencil icon-white"></i></button></a></div></td>
                                           </td>
												<td>	<a  id="deleteUser{{ $user->account_id}}" data-userid="{{ $user->account_id }}" href="javascript:void(0)" onclick="showAlert({{ $user->account_id}});"><button class="btn btn-danger"><i class="icon-remove icon-white"></i></button></a></div></td>
                                           </tr>
 ...
 <div id="success" class="modal hide">
	 ...
	 {{ csrf_field() }}
                              ...
                              <div class="control-group">
  								<label class="control-label" style="text-align:left"><b>Phone</b><span class="required">*</span></label>
  								<div class="controls">
                              ...
                              <div class="control-group">
  								<label class="control-label" style="text-align:left"><b>Account Type:</b><span class="required">*</span></label>
  								<div class="controls">
                                      <table><tr><td> <input disabled  type="text" id="acctype_value" name="acctype_value" data-required="1" class="span6 m-wrap" style="width:100%;height:30px" required>
  								</td><td><select id="acct" name="acct" onchange="changeacct();"  style="width:100%;height:30px"  required>
								<option>Change account type</option>
...
function senddel(){
    ...
    window.location="/user/delete/"+$('#app_id').val();
...
function showAlertEdit(operand){
    ...
    $.get('pullusersdetail/'+id,function(user){
       ...
       // $("#pass").val(user.password);
        ...
        $("#acctype_value").val(user.acctype);
